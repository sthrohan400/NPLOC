<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  ...
  <a class="navbar-brand brand-logo" href="{{url('/admin/dashboard')}}"><img src="{{URL::asset('/system/logo/logo.jpg')}}" alt="logo"></a>
    <a class="navbar-brand brand-logo-mini" href="{{url('/admin/dashboard')}}"><img src="{{URL::asset('/system/logo/kevdor.jpg')}}" alt="logo"></a>
  </div>
    ...
    <ul class="navbar-nav ml-lg-auto">
      ...
      <li class="nav-item d-none d-sm-block profile-img">
        <a class="nav-link profile-image" href="#">
          <img src="{{URL::asset('/system/logo/kevdor.jpg')}}" alt="profile-img">
